...
/*
 *	DAO => classe responsável por manipular os dados no BD
...
public class CargoDAO {
	...
	public int add(Cargo objeto) throws Exception{
		stmt = con.prepareStatement
				("INSERT INTO TB_CARGO (NR_ID, NM_CARGO, VL_SALARIO, NM_NIVEL) "
						+"VALUES (?,?,?,?)");
 ...
 * 		executeUpdate() -> retorna a qtde de linhas afetadas no BD
 * 		executeQuery() -> deve ser usado somente com select, pq retorna ResultSet
