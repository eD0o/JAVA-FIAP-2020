...
public class main {
	...
	public static void main(String[] args) {
		...
		/* Escreva um programa em Java para calcular o salário de um funcionário. Ao ser executado, o
	    ...
	    JOptionPane.showMessageDialog(null,"Seu salário será de: " + salario);
